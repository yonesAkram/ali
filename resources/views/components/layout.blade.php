...
<body class="h-full">
    ...
    <div class="bg-gray-900">
            ...
            <el-dialog>
                <dialog id="mobile-menu" class="backdrop:bg-transparent lg:hidden">
                    <div tabindex="0" class="fixed inset-0 focus:outline-none">
                        <el-dialog-panel
                            class="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-gray-300 p-6 sm:max-w-sm sm:ring-1 sm:ring-gray-100/10">
        ...
        <main class="pt-24 px-9">
            <div class="text-white sm:text-xl">
                {{ $slot }}
            </div>
        </main>
        <div class="relative isolate px-6 pt-14 lg:px-8">
            ...
            <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
                ...
                <div class="text-center">
                    <h1 class="text-5xl font-semibold tracking-tight text-balance text-white sm:text-7xl">Data to
                        enrich
    ...
    {{-- // write the content of about.blade.php and contact.blade.php --}}
    {{-- {{ $slot }} --}}
</body>
